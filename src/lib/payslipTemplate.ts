...
export interface PayslipTemplate {
   ...
   *  Default = Malkia Maternity teal. */
  accentColor: string
  /** Secondary accent (used sparingly — section dividers, soft
   *  highlights). Default = Malkia purple. */
   ...
   *  Default: 'Reimagining Motherhood' (Malkia Maternity voice). */
...
export const DEFAULT_PAYSLIP_TEMPLATE: PayslipTemplate = {
  // Malkia Maternity palette — deep teal + soft purple, soft and human.
