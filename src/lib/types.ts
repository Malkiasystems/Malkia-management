export type Page =
  ...
  | 'sales' | 'inventory' | 'reports' | 'pnl' | 'sales-register' | 'sales-day-book' | 'trial-balance' | 'balance-sheet' | 'ar-aging' | 'ap-aging' | 'vat-report' | 'stock-valuation' | 'purchase-register' | 'payment-register' | 'receipt-template' | 'invoice-template' | 'whatsapp-settings' | 'location-settings'
  | 'purchase-register' | 'payment-register' | 'receipt-template' | 'invoice-template' | 'whatsapp-settings' | 'location-settings' | 'trial-balance'
