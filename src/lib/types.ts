export type Page =
  ...
  | 'opening-stock' | 'bank-opening-balance' | 'loans' | 'new-loan' | 'opening-loans' | 'loan-repayment' | 'stock-adjustment' | 'stock-transfer' | 'journal-entry' | 'import-order'
  ...
  | 'banks' | 'cash-center' | 'cash-flow' | 'day-close' | 'ledger-health' | 'product-profit' | 'ar-followup' | 'settings' | 'data-import' | 'coming-soon' | 'bundles'
