...
const KEYWORDS: Record<string, string> = {
  ...
  'kit-assembly': 'kit bundle bom assemble build recipe manufacture combo set',
...
const PAGE_ICON: Record<string, string> = {
  ...
  'inventory': P.box, 'bundles': P.box, 'services': P.box, 'kit-assembly': P.box, 'stock-count': P.clipboard, 'stock-as-of': P.clipboard,
...
const MODULE_EXPLICIT: Record<string, string> = {
  ...
  'bundles': 'Catalogue', 'iu-returns': 'Catalogue', 'kit-assembly': 'Catalogue',
