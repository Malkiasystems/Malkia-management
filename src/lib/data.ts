...
export const BREADCRUMBS: Record<string, string> = {
  ...
  'banks':'Banks & Cash', 'trial-balance':'Trial Balance', 'balance-sheet':'Balance Sheet', 'ar-aging':'AR Aging', 'ap-aging':'AP Aging', 'vat-report':'VAT Report', 'stock-valuation':'Stock Valuation', 'purchase-register':'Purchase Register', 'payment-register':'Payment Register', 'settings':'Settings', 'coming-soon':'Coming Soon', 'stock-levels':'Stock Levels',
