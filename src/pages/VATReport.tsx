...
export default function VATReport() {
  ...
  const exportPDF = () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>VAT Report</title>
      ...
      <div class="header">
        <div class="logo-area"><div class="logo-mark"><div class="logo-inner"></div></div><div><div class="company-name">Malkia Wellness Group Ltd</div><div class="company-sub">Dar es Salaam, Tanzania · VAT Report for TRA</div></div></div>
