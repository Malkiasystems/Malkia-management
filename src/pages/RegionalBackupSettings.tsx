...
export default function RegionalBackupSettings({ onNav }: Props) {
  ...
  return (
    ...
    >
      <SettingsSection title="Language & Formats" description="How MalkiaOS displays text, numbers, and dates across the app">
        ...
        {backup.auto_export_enabled && (
          <>
            ...
            <FG label="Email Recipients">
              <input className="form-input" value={recipientsInput} onChange={e => setRecipientsInput(e.target.value)} placeholder="joe@malkia.co.tz, accountant@firm.co.tz" />
