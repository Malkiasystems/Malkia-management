        ...
        <div className="grid g2" style={{ gap: 20 }}>
            ...
            <div style={{ marginBottom: 14 }}>
              <FG label="Costing Method">
                <select className="form-input" value={settings.costing_method} onChange={e => set('costing_method', e.target.value)}>
                  <option value="average">Average Cost (Recommended for Malkia)</option>
                  <option value="fifo">FIFO — First In First Out</option>
                  <option value="specific">Specific Identification</option>
                </select>
              </FG>
              <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 4 }}>Average cost recalculates on every GRN. Best for Malkia's import model.</div>
            </div>
          ...
          <div className="card" style={{ background: 'linear-gradient(135deg, rgba(212,135,74,.08) 0%, rgba(212,135,74,.04) 100%)', border: '1px solid rgba(212,135,74,.2)', borderRadius: 12, padding: 16 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--text2)', lineHeight: 1.8 }}>
              ...
              This is the correct method for Malkia because you buy in USD and the rate changes. Each shipment may have a different landed cost. Average cost smooths this out across your entire stock.
            </div>
          </div>
        </div>
      )}
