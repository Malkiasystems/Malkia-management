    ...
    setAutomations([
      {
        ...
        triggerType: 'event',
        delay: 'Wait 1 hour',
        messageTemplate: 'Habari [Jina]! Asante kwa kununua [Bidhaa] kutoka Malkia 💚 Hapa kuna jinsi ya kutumia vizuri: [Link]. Una swali lolote? Tupigie WhatsApp!',
        sent: 342,
        delivered: 322,
        opened: 219,
        clicked: 87,
      ...
      },
      {
        ...
        triggerType: 'event',
        messageTemplate: '🎉 Hongera [Jina]! Umefika Crown tier! Sasa una heshima ya pekee katika familia ya Malkia. Funguo za VIP group zimekuwa zako: [Link]',
        sent: 12,
        delivered: 12,
        opened: 11,
        clicked: 9,
      ...
      },
      {
        ...
        messageTemplate: 'Hongera siku yako ya kuzaliwa [Jina]! 🎂 Malkia inakutakia siku njema! Tumekupa zawadi: 15% discount kwa wiki hii. Code: BIRTHDAY[JINA]',
        sent: 34,
        delivered: 33,
        opened: 28,
        clicked: 12,
