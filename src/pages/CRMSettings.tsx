...
export default function CRMSettings() {
      ...
      <>
        ...
        <div style={s.card}>
          ...
          <div style={{ marginTop: 12, padding: 16, background: 'var(--surface2)', borderRadius: 8, fontFamily: 'var(--mono)', fontSize: 13 }}>
            https://wa.me/255712345678?text=Hi%20Malkia!%20Referred%20by%20<span style={{ color: 'var(--accent)' }}>[CODE]</span>
          </div>
          <div style={{ ...s.hint, marginTop: 12 }}>
            When clicked, opens WhatsApp with pre-filled message containing referral code.
            Future: Custom landing page at malkia.co.tz/r/[code]
          </div>
        </div>
      </>
    )
  ...
  const renderAutomationTab = () => {
    ...
    const leadReminder = getSetting('automation', 'lead_reminder', { enabled: true, days: 2 })
