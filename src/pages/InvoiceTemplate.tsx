      ...
      <div style={{ padding: '32px 40px 24px', borderBottom: `3px solid ${p}` }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <img src={MALKIA_LOGO} alt="Malkia" style={{ height: 64, width: 'auto', objectFit: 'contain', filter: 'brightness(0) saturate(100%) invert(70%) sepia(30%) saturate(500%) hue-rotate(140deg)' }} />
            <div>
