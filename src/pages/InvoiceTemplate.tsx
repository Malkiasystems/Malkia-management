    ...
    <div id="malkia-invoice" style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0 }}>
        <div style={{ padding: '20px 40px', borderRight: '1px solid #f0f0f0' }}>
          ...
          <div style={{ fontFamily: "'Syne', serif", fontSize: 15, fontWeight: 700, color: '#1a1a1a', marginBottom: 2 }}>{cust?.company || cust?.name || '—'}</div>
              {cust?.contact_person && <div style={{ fontSize: 12, color: '#555', marginBottom: 2 }}>Attn: {cust.contact_person}</div>}
