    ...
    <div id="malkia-invoice" style={{
      ...
      <div style={{ padding: '32px 40px 24px', borderBottom: `3px solid ${p}` }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          {/* Left — Logo + Company */}
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, maxWidth: '55%' }}>
            <img src={s.logo_url || MALKIA_LOGO} alt="Malkia" style={{ height: 110, width: 'auto', objectFit: 'contain', flexShrink: 0, marginTop: -8 }} />
            <div>
