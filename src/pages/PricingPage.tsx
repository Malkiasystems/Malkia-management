...
function PricelistDoc({ products, bundles, config }: {
  ...
  return (
    <div id="malkia-pricelist-doc" style={{ width: 680, background: '#fff', fontFamily: "'Instrument Sans', sans-serif", color: '#1a1a1a', fontSize: 12 }}>
      {/* Header */}
      <div style={{ background: 'linear-gradient(135deg, #85c2be 0%, #6ba8a4 50%, #f7a6ad 100%)', padding: '28px 32px', color: '#fff', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 22, fontWeight: 800 }}>Malkia Maternity</div>
      ...
      <div style={{ background: '#1a1a1a', color: '#fff', padding: '22px 24px' }}>
        ...
        <div style={{ marginTop: 14, paddingTop: 14, borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: 10, opacity: 0.4 }}>📞 {config.whatsapp} · @malkiamaternity</span>
          <span style={{ fontSize: 10, opacity: 0.3 }}>Malkia Maternity · Your Partner in Motherhood</span>
        </div>
      </div>
    </div>
  )
