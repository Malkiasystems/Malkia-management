...
const RIcon = ({ name }: { name: string }) => {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    vat:      <svg {...p}><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2"/><line x1="16" y1="8" x2="8" y2="8"/><line x1="16" y1="12" x2="8" y2="12"/></svg>,
  ...
  const SECTIONS = [
    ...
    },
    {
      title: 'Receivables & Payables', reports: [
        ...
        { name: 'VAT Report', icon: 'vat', page: 'vat-report' as Page, desc: 'Output VAT for TRA filing' },
      ]
    },
    {
