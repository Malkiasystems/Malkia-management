...
export default function HRMPayslipTemplate({ onNav: _onNav }: HRMProps) {
  ...
  const resetDefaults = () => {
    if (!confirm('Reset to Malkia Maternity defaults? This wipes all your customisations.')) return
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 360px)', gap: 18 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <Card title="Brand Colors">
            ...
            <Hint>
              Default is Malkia Maternity teal + violet. Stick close to your brand for recognition. Use the swatches below for inspiration.
            </Hint>
            <SwatchRow
              swatches={[
                { name: 'Malkia Teal', value: '#0F766E' },
                { name: 'Malkia Violet', value: '#7C3AED' },
