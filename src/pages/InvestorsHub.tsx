...
export default function InvestorsHub() {
  ...
  const generateReportPDF = async () => {
    let tplSettings = { company_name: 'Malkia Brands Ltd', company_tagline: 'Building African Brands', primary_color: '#d48744', logo_url: null as string | null, logo_position: 'left', logo_width: 50 }
    try {
    ...
    <div class="page">
      ...
      <div class="content">
        ...
        <div class="footer">
          ...
          <div>Generated ${now} · MalkiaOS · Confidential</div>
        </div>
      </div>
    </div></body></html>`)
