...
export default function Suppliers({ onNav }: { onNav?: (p: Page) => void }) {
  ...
  const exportStatementPDF = async () => {
    ...
    let tplSettings = { company_name: 'Malkia Wellness Group Ltd', company_tagline: 'Reimagining Motherhood', primary_color: '#85c2be', logo_url: null as string | null, logo_position: 'left', logo_width: 50 }
    try {
      ...
      {onNav && (
        <div className="shortcut-bar">
          {[
            ...
            { icon: 'M12 1v22 M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6', label: 'Cash Payment', page: 'cash-payment' as Page },
