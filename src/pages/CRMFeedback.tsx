...
export default function CRMFeedback({ onNav }: Props) {
  ...
  const loadData = async () => {
    ...
    setFeedbackItems([
      ...
      { id: '2', customer_name: 'Grace Mwanza', customer_phone: '+255 754 987 654', tier: 'crown', type: 'testimonial', rating: 5, product: 'Belly Binder', message: 'Binder imenisaidia kupona haraka baada ya C-section. Sasa naweza kusimama na kutembea bila maumivu. Asante Malkia!', status: 'approved', priority: 'low', createdAt: '1 day ago' },
      ...
      { id: '7', customer_name: 'Zainab Ally', customer_phone: '+255 621 333 444', tier: 'gold', type: 'testimonial', rating: 5, product: 'Delivery Kit', message: 'Delivery Kit iliokoa maisha yangu hospitali! Nilikuwa na kila kitu nilichohitaji. Asante Malkia kwa huduma nzuri.', status: 'approved', priority: 'low', createdAt: '1 week ago' },
    ])
