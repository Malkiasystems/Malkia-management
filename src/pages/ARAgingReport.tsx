...
export default function ARAgingReport() {
  ...
  const exportPDF = () => {
    ...
    const printRes = printHtmlDocument(`<!DOCTYPE html><html><head><meta charset="utf-8"><title>AR Aging</title>
      ...
      <div class="header">
        <div class="logo-area"><div class="logo-mark"><div class="logo-inner"></div></div><div><div class="company-name">Malkia Wellness Group Ltd</div><div class="company-sub">Dar es Salaam, Tanzania · AR Aging Report</div></div></div>
