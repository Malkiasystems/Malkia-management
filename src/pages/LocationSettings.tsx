      ...
      {showBranchModal && (
        <div style={{ position:'fixed',inset:0,background:'rgba(0,0,0,.7)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:100 }}>
          <div style={{ background:'var(--surface)',border:'1px solid var(--border)',borderRadius:16,padding:28,width:480 }}>
            ...
            <FG label="Branch Name" req><input className="form-input" placeholder="e.g. Malkia HQ — Dar es Salaam" value={branchForm.name} onChange={e => setB('name', e.target.value)} /></FG>
