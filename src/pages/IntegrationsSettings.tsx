...
export default function IntegrationsSettings({ onNav }: Props) {
  ...
  return (
    <SettingsPage
      title="Integrations"
      subtitle="Connect MalkiaOS to external services — messaging, payments, tax compliance"
    ...
    >
      ...
      <SettingsSection title="API Access" description="Build custom integrations using the MalkiaOS API (Supabase REST endpoints)">
