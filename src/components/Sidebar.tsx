...
const HRM_PAGES: Page[] = ['hrm', 'hrm-employees', 'hrm-assets', 'hrm-payroll', 'hrm-payslips', 'hrm-payslip-template', 'hrm-leave', 'hrm-attendance', 'hrm-performance', 'hrm-recruitment', 'hrm-events', 'hrm-settings', 'hrm-kpi', 'attendance-checkin', 'attendance-kiosk']
...
const HRM_SUB: { label: string; page: Page; icon: string }[] = [
  ...
  { label: 'Check In',  page: 'attendance-checkin', icon: 'M9 11l3 3L22 4 M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11' },
  { label: 'Kiosk',     page: 'attendance-kiosk',   icon: 'M2 3h20v14H2z M8 21h8 M12 17v4' },
...
const ACCOUNTS_SUB: { label: string; page: Page; icon: string }[] = [
  ...
  { label: 'Loans',        page: 'loans',            icon: 'M12 1v22 M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6' },
]
...
export default function Sidebar({ current, onNav, stockMode }: SidebarProps) {
  ...
  if (stockMode) {
    const STOCK_NAV: { label: string; page: Page; icon: string }[] = [
      ...
      { label: 'Inventory', page: 'inventory',                icon: 'M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z M3.27 6.96 12 12.01l8.73-5.05 M12 22.08V12' },
      { label: 'Receive',   page: 'purchase',                 icon: 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4 M7 10l5 5 5-5 M12 15V3' },
